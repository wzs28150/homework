define(['pajax', 'debouncedresize', 'router', 'smoothscroll', 'scroll', 'search'], function (pajax, debouncedresize, router, smoothscroll, scroll, search) {
  var initModule, animated_contents, minheight, alertinfo, msg, exists, search = search.initModule;
  /**
   * 判断dom是否存在
